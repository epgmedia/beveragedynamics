		...
		return array(
			'posterboard_events_per_page' => array(
				...
				'renderer' => array(
					...
					'tab'       => 'extensions',
					'item'      => 'extended_views',
					'label'     => __( 'Posterboard pages show at most', AI1ECEV_PLUGIN_NAME ),
					'type'      => 'append',
					'append'    => 'events',
					'validator' => 'numeric',
				)
			...
			'stream_events_per_page' => array(
				...
				'renderer' => array(
					...
					'tab'       => 'extensions',
					'item'      => 'extended_views',
					'label'     => __( 'Stream pages show at most', AI1ECEV_PLUGIN_NAME ),
					'type'      => 'append',
					'append'    => 'events',
					'validator' => 'numeric',
				)
			...
			'posterboard_tile_min_width' => array(
				...
				'renderer' => array(
					...
					'tab'       => 'extensions',
					'item'      => 'extended_views',
					'label'     => __( 'Posterboard tile minimum width', AI1ECEV_PLUGIN_NAME ),
					'type'      => 'append',
					'append'    => 'px',
					'validator' => 'numeric',
				)
			...
			'posterboard_equal_height' => array(
				...
				'renderer' => array(
					...
					'tab'       => 'extensions',
					'item'      => 'extended_views',
					'label'     => __( 'Align Posterboard tiles to a grid',
										AI1ECEV_PLUGIN_NAME ),
					'help'      => __( 'Forces posterboard tiles within a row to share the same
										height, improving chronological ordering.' ),
					'type'      => 'append',
				),
				'default'  => false,
			)
