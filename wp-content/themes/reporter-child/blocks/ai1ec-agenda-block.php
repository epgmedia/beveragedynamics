...
class Ai1ec_Agenda_Block extends AQ_Block {
    function __construct() {
        $block_options = array(
            'name' => 'Upcoming Events',
            'size' => 'span4',
        );
        parent::__construct('ai1ec_agenda_block', $block_options);
    }
    /**
     * form function
     *
    ...
    function form( $instance )
    {
        ...
        $default = array(
            'title'                  => __( 'Upcoming Events', 'engine' ),
        ...
        $get_events        = new WP_Query( array ( 'post_type' => 'ai1ec_event', 'posts_per_page' => -1 ) );
        ...
        require_once('agenda-widget-form.php');
    }
